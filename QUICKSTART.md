...
This will create/update the admin user with default password: `ssc2526`
...
Just in case the localhost:3000 doesn't work, it will work with localhost:3001
...
Login with: staff (Charity Herreria)
- **Username:** `staff`
- **Password:** `sscguidance`

Login with: staff1 (Ivan Jade Surat)
- **Username:** `staff1`
- **Password:** `ssc2627`
...
## To run SQL command
- docker exec -it student_violation_db mysql -u root -p
- password: root
