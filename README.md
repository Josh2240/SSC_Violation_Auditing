...
This project is developed for PCLU (Polytechnic College of La Union).
...
### UPDATES:
1. added header to User Management page
2. changed the username from admin to systemadmin from sql

### FIXING SQL:
1. to test mysql directly, run "C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql.exe" -u root -p